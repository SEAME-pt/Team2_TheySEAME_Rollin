...
Middlewares/SEGGER/RTT/%.o: ../Middlewares/SEGGER/RTT/%.S Middlewares/SEGGER/RTT/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m33 -g3 -DDEBUG -DTX_SINGLE_MODE_NON_SECURE=1 -c -I../Middlewares/SEGGER/Config -I../Middlewares/SEGGER/RTT -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
